...
const (
	Messages_SendMessage_FullMethodName = "/message.Messages/SendMessage"
	Messages_GetMessages_FullMethodName = "/message.Messages/GetMessages"
)
...
func (c *messagesClient) GetMessages(ctx context.Context, in *GetMessagesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Message], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedMessagesServer) GetMessages(*GetMessagesRequest, grpc.ServerStreamingServer[Message]) error {
...
func _Messages_GetMessages_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(MessagesServer).GetMessages(m, &grpc.GenericServerStream[GetMessagesRequest, Message]{ServerStream: stream})
}
